      ...
      <div className="container flex h-14 sm:h-16 items-center justify-between">
        <Link to="/" className="flex items-center gap-2.5">
          <div className="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-lg">
            <img
              src="/assets/morlogo.png"
              alt="MOR Logo"
              className="h-8 w-8 sm:h-10 sm:w-10 object-contain"
            />
          </div>
          <div className="flex flex-col">
            <span className="font-display text-xs sm:text-sm font-bold text-foreground leading-tight">
              MOR
            </span>
        ...
        <nav className="hidden md:flex items-center gap-6">
          ...
          <Link
            to="/register"
            className={`text-sm font-medium transition-colors ${location.pathname.startsWith("/register") ? "text-primary" : "text-muted-foreground hover:text-foreground"}`}
          >
            Register
          </Link>
          <Link
            to="/track"
            className={`text-sm font-medium transition-colors ${location.pathname === "/track" ? "text-primary" : "text-muted-foreground hover:text-foreground"}`}
          >
            Track
          </Link>
        </nav>
